...
gulp.task('images', function () {
    ...
    return gulp
        .src(paths.images)
        // currently an issue with the minification or cache
...
gulp.task('clean', function (cb) {
    ...
    var delPaths = [].concat(paths.build, paths.analysis);
    del(delPaths, cb);
});
...
function analyzejshint(sources, overrideRcFile) {
    var jshintrcFile = overrideRcFile || paths.jshintrc;
    log('Running JSHint');
    return gulp
        .src(sources)
...
function startTests(singleRun, done) {
    var child;
    var excludeFiles = ['./src/client/js/**/*.spaghetti.js'];
